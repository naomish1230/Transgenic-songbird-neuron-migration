...
%remove correlations that are with self (cell pair < 5 microns away) 
birds_headCorrs_table(birds_headCorrs_table.DistDiffs < 5,:) = [];

%Check if correlations in the population are above chance 
...
% Check if there is a relationship between correlation and distance with linear regression 
...
% Check if there is a relationship between correlation and distance
